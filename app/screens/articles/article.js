        ...
        return (
            <View style={styles.root}>
                ...
                <View style={{padding:20}}>
                    <RkText rkType='primary3 bigLine' style={{fontSize:15, fontFamily:'SF-UI',fontWeight:'600', color:'#666666',marginBottom: 20}}>{this.data.publishedDate }  {' , '} {this.data.mediaDuration}</RkText>
                    <HTMLView
                        value={htmlText}
